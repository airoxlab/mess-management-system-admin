...
// Membership types (for member registration)
...
// Package types (for meal packages)
export const PACKAGE_TYPE = {
  FULL_TIME: 'full_time',
  PARTIAL_FULL_TIME: 'partial_full_time',
  PARTIAL: 'partial',
...
export const PACKAGE_TYPE_LABELS = {
  full_time: 'Full Time',
  partial_full_time: 'Partial Full Time',
  partial: 'Partial',
  daily_basis: 'Daily Basis',
};

export const PACKAGE_TYPE_DESCRIPTIONS = {
  full_time: 'Fixed period with start/end dates. Select meals and days. Remaining meals expire at end date.',
  partial_full_time: 'Same as Full Time but you can manually disable specific days on the calendar.',
  partial: 'No time limit. Use meals until exhausted. Remaining meals can carry over to new package.',
  daily_basis: 'Credit-based system. Deposit money and pay per meal consumed.',
};
